...
public function getOrderOptionValue($product_option_value_id) {
        $query = $this->db->query("SELECT `value` FROM `" . DB_PREFIX . "order_option` WHERE `product_option_value_id` = '" . (int)$product_option_value_id . "'");
