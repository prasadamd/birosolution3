...
class ControllerSaleOrder extends Controller {
    ...
    protected function getList() {
        ...
        $data['invoiceMail'] = $this->url->link('sale/order/invoiceMail', 'user_token=' . $this->session->data['user_token'], true);
        ...
        if (!empty($order_info)) {
            ...
            foreach ($products as $product) {
                $data['order_products'][] = array(
                    ...
                    "weight"     => $this->model_sale_order->getProductWeight($product['product_id']),//A fost adaugat greutatea
                    'price'      => $product['price'],
                    'total'      => $product['total'],
...
public function info() {
        ...
        if ($order_info) {
            ...
            $data['invoiceMail'] = $this->url->link('sale/order/invoiceMail', 'user_token=' . $this->session->data['user_token'] . '&order_id=' . (int)$this->request->get['order_id'], true);
            ...
            foreach ($products as $product) {
                ...
                $product_options = $this->model_sale_order->getProductOptions($product['product_id']);
        ...
        foreach ($orders as $order_id) {
            ...
            if ($order_info) {
                ...
                foreach ($products as $product) {
                    ...
                    // $Id_option = $this->model_sale_order->getProductOptionsID($product['order_product_id']);
                    // $optionValue=$this->model_sale_order->getOrderOptionValue($Id_option);
    ...
    public function invoiceMail() {
        ...
        $this->response->setOutput($this->load->view('sale/order_invoice_Mail', $data));
    }
