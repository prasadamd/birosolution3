<?php
class ModelExtensionFeedFbProductCatalog extends Model {
    public function getLanguageId($lang_code) {
    	$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "language` WHERE `code` = '" . $this->db->escape($lang_code) . "'");
